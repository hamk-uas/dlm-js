...
- Dependencies: `@hamk-uas/jax-js-nonconsuming` (includes the eslint plugin as a sub-path export) is installed from `github:hamk-uas/jax-js-nonconsuming#cd8d47a` (post-v0.8.0: constants → uniform buffers, enabling 5-tuple block-map on WebGPU).
