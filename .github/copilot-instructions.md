...
- Dependencies: `@hamk-uas/jax-js-nonconsuming` (includes the eslint plugin as a sub-path export) is installed from `github:hamk-uas/jax-js-nonconsuming#v0.9.2` (v0.9.2 release: leaf packing for 6+ tuple associative scan, flushBatch, 16-byte malloc floor; built on v0.9.1).
