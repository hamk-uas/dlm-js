...
- Dependencies: `@hamk-uas/jax-js-nonconsuming` (includes the eslint plugin as a sub-path export) is installed from `github:hamk-uas/jax-js-nonconsuming#v0.9.0` (v0.9.0 release: colored multi-slab arena allocator O9a-v2, constants slab O9c with conflict-graph coloring, deterministic GPU teardown; built on v0.8.4).
