...
- Dependencies: `@hamk-uas/jax-js-nonconsuming` (includes the eslint plugin as a sub-path export) is installed from `github:hamk-uas/jax-js-nonconsuming#v0.8.2` (v0.8.2 release: all v0.8.1 features plus dispatch counter via `WebGPUBackend.dispatchCount`/`resetDispatchCount()`).
