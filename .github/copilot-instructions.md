...
- Dependencies: `@hamk-uas/jax-js-nonconsuming` (includes the eslint plugin as a sub-path export) is installed from `github:hamk-uas/jax-js-nonconsuming#v0.8.4` (v0.8.4 release: v0.8.2 features plus command tape, analytical Cholesky, Dot vmap batch fix, integer dtype WAS shader fix).
