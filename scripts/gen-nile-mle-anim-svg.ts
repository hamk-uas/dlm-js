...
push(`<text x="${W / 2}" y="16" text-anchor="middle" fill="#333" font-size="12" font-weight="600">Nile demo — MLE (order=1, trend), ${iterations} ${optimizer} iters, ${elapsedMs} ms, ${backendLabel}</text>`);
