...
export const artifactGroups: ArtifactGroup[] = [
  // ── dlmFit SVGs (scan/assoc/sqrt-assoc variants) ────────────────────────
  {
    ...
    sources: [
      ...
      "scripts/gen-multivariate-svg.ts",
    ...
    outputs: [
      ...
      "assets/multivariate-demo-scan.svg",
      "assets/multivariate-demo-assoc.svg",
      ...
      "assets/timings/gen-multivariate-svg.json",
      "assets/timings/gen-multivariate-svg-assoc.json",
    ],
