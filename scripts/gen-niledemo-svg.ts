...
// Title
push(`<text x="${margin.left + plotW / 2}" y="${16}" text-anchor="middle" fill="#333" font-size="14" font-weight="600">Nile demo — fit (order=1, trend), cold ${timed.firstRunMs.toFixed(0)} ms, warm ${timed.warmRunMs.toFixed(0)} ms, ${scanLabel}</text>`);
