...
if (jitBarW > 0) {
  ...
  push(`<text x="${r(sparkX + jitBarW / 2)}" y="${r(sparkY1 + sparkH1 / 2)}" text-anchor="middle" dominant-baseline="middle" fill="#9ca3af" font-size="7">jit</text>`);
...
push(`<text x="${r(sparkX_train + trainSparkW / 2)}" y="${r(sparkY1 + sparkH1 / 2)}" text-anchor="middle" dominant-baseline="middle" fill="#9ca3af" font-size="7">train ${trainMs}ms</text>`);
