...
// Title
push(`<text x="${W / 2}" y="18" text-anchor="middle" fill="#333" font-size="14" font-weight="600">Nile demo (gapped data, ${jsResult.nobs}/${y.length} observed) — fit (order=1, trend), cold ${firstRunMs.toFixed(0)} ms, warm ${warmRunMs.toFixed(0)} ms, ${scanLabel}</text>`);
