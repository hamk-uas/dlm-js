...
declare function scan<Carry extends JsTree<Array>, X extends JsTree<Array>, Y extends JsTree<Array>>(f: (carry: Carry, x: X) => [Carry, Y], init: Carry, xs: X, options?: number | ScanOptions): [Carry, Y];
/**
