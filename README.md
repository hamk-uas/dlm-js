...
|---------|-------|-----------|------|-------|------|-------|------|-------|------|-------|------|-------|------|-------|------|
| **cpu** | **f64** | **scan** | **triu** | **154 ms** | **1.73e-16** | **353 ms** | **4.78e-13** | **435 ms** | **4.20e-11** | **490 ms** | **1.19e-11** | **504 ms** | **1.82e-11** | **353 ms** | **2.52e-13** |
|  |  | scan | off | 138 ms | 1.73e-16 | 271 ms | 1.40e-11 | 355 ms | 5.85e-10 | 397 ms | 1.06e-6 | 405 ms | 2.09e-4 | 283 ms | 1.03e-12 |
|  |  | assoc | built-in | 75 ms | 4.87e-12 | 215 ms | 4.36e-9 | 1023 ms | 3.17e-8 | 1857 ms | 2.17e-7 | 1854 ms | 2.28e-7 | 217 ms | 1.29e-9 |
|  |  | ud | built-in | 258 ms | 1.30e-14 | 685 ms | 1.43e-12 | 1371 ms | 4.01e-5 | 1738 ms | 1.56e-10 | 1844 ms | 7.36e-9 | 705 ms | 9.55e-14 |
|  | **f32** | **scan** | **joseph** | **142 ms** | **9.93e-7** | **315 ms** | **2.25e-4** | **409 ms** | **2.93e-3** | **466 ms** | **6.18e-4** | **469 ms** | **0.13** | **323 ms** | **1.74e-5** |
|  |  | scan | joseph+triu | 179 ms | 9.93e-7 | 363 ms | 1.09e-4 | 471 ms | 8.98e-3 | 530 ms | 1.41e-3 | 521 ms | 8.40e-3 | 366 ms | 1.40e-4 |
|  |  | assoc | built-in | 64 ms | 4.74e-6 | 205 ms | 3.93e-3 | 1033 ms | 0.03 | 1886 ms | 0.20 | 1883 ms | 0.22 | 215 ms | 1.51e-3 |
|  |  | ud | built-in | 247 ms | 3.99e-6 | 690 ms | 4.07e-4 | 1351 ms | 0.01 | 1708 ms | 6.82e-4 | 1688 ms | 0.04 | 684 ms | 7.96e-5 |
| **wasm** | **f64** | **scan** | **triu** | **6 ms** | **1.73e-16** | **5 ms** | **4.78e-13** | **5 ms** | **4.20e-11** | **6 ms** | **1.19e-11** | **5 ms** | **1.82e-11** | **4 ms** | **2.52e-13** |
|  |  | scan | off | 4 ms | 1.73e-16 | 5 ms | 1.40e-11 | 4 ms | 5.85e-10 | 4 ms | 1.06e-6 | 5 ms | 2.09e-4 | 3 ms | 1.03e-12 |
|  |  | assoc | built-in | 16 ms | 4.87e-12 | 19 ms | 4.36e-9 | 45 ms | 3.17e-8 | 59 ms | 2.17e-7 | 51 ms | 2.28e-7 | 19 ms | 1.29e-9 |
|  |  | sqrt-assoc | built-in | 69 ms | 2.60e-15 | 111 ms | 3.55e-12 | 262 ms | 2.03e-6 | 364 ms | 1.70e-10 | 356 ms | 9.88e-7 | 111 ms | 1.94e-13 |
|  |  | ud | built-in | 6 ms | 1.30e-14 | 7 ms | 1.43e-12 | 10 ms | 4.01e-5 | 12 ms | 1.56e-10 | 10 ms | 7.36e-9 | 6 ms | 9.55e-14 |
|  | **f32** | **scan** | **joseph** | **3 ms** | **1.06e-6** | **4 ms** | **2.59e-4** | **4 ms** | **0.01** | **4 ms** | **2.08e-3** | **4 ms** | **0.07** | **4 ms** | **1.32e-4** |
|  |  | scan | joseph+triu | 5 ms | 1.06e-6 | 5 ms | 7.11e-4 | 5 ms | 0.02 | 5 ms | 1.34e-3 | 5 ms | 0.10 | 4 ms | 2.48e-4 |
|  |  | assoc | built-in | 15 ms | 4.74e-6 | 20 ms | 4.53e-3 | 41 ms | 0.03 | 53 ms | 0.22 | 53 ms | 0.07 | 19 ms | 1.19e-3 |
|  |  | sqrt-assoc | built-in | 69 ms | 7.50e-7 | 115 ms | 1.41e-3 | 249 ms | 1.98 | 329 ms | 0.02 | 330 ms | 1.13 | 122 ms | 6.93e-4 |
|  |  | ud | built-in | 5 ms | 1.06e-6 | 6 ms | 1.78e-3 | 9 ms | 9.17e-3 | 13 ms | 1.22e-3 | 10 ms | 0.01 | 6 ms | 1.51e-4 |
| **webgpu** | **f32** | **assoc** | **built-in** | **33 ms** | **4.74e-6** | **35 ms** | **4.28e-3** | **61 ms** | **0.03** | **62 ms** | **0.18** | **65 ms** | **0.09** | **35 ms** | **4.07e-4** |
|  |  | scan | joseph | 87 ms | 3.99e-6 | 89 ms | 6.34e-5 | 97 ms | 9.85e-3 | 101 ms | 1.06e-3 | 104 ms | 0.02 | 86 ms | 2.56e-5 |
|  |  | scan | joseph+triu | 80 ms | 3.99e-6 | 64 ms | 6.34e-5 | 52 ms | 0.03 | 61 ms | 2.88e-3 | 64 ms | 0.17 | 60 ms | 8.20e-5 |
|  |  | ud | built-in | 136 ms | 1.27e-5 | 152 ms | 7.31e-4 | 136 ms | 0.03 | 163 ms | 6.28e-4 | 160 ms | 0.01 | 150 ms | 3.35e-5 |
<!-- /generated -->
...
- **WASM stays flat up to N≈3200, then scales linearly** (\~<!-- timing:scale:wasm-f64:n1638400 -->1378 ms (warm)<!-- /timing --> at N=1.6M). WebGPU scales sub-linearly at small N but approaches O(N) at large N (<!-- timing:scale:webgpu-f32:n100 -->1291 ms (cold)<!-- /timing --> → <!-- timing:scale:webgpu-f32:n102400 -->2459 ms (cold)<!-- /timing --> for a 1024× increase). No crossover was observed up to N=1.6M; see scaling table.
...
|-------|-----|-----|--------------------------|------------------------------|
| Nile, order=0 | 100 | 1 | <!-- timing:bb:nile-o0:wasm-f64 -->6 ms<!-- /timing --> | <!-- timing:bb:nile-o0:webgpu-f32 -->35 ms<!-- /timing --> |
| Nile, order=1 | 100 | 2 | <!-- timing:bb:nile-o1:wasm-f64 -->6 ms<!-- /timing --> | <!-- timing:bb:nile-o1:webgpu-f32 -->34 ms<!-- /timing --> |
| Kaisaniemi, trig | 117 | 4 | <!-- timing:bb:kaisaniemi:wasm-f64 -->6 ms<!-- /timing --> | <!-- timing:bb:kaisaniemi:webgpu-f32 -->62 ms<!-- /timing --> |
| Energy, trig+AR | 120 | 5 | <!-- timing:bb:trigar:wasm-f64 -->6 ms<!-- /timing --> | <!-- timing:bb:trigar:webgpu-f32 -->75 ms<!-- /timing --> |
...
|---|----------------------|-------------------------|-------|
| 100 | <!-- timing:scale:wasm-f64:n100 -->7 ms<!-- /timing --> | <!-- timing:scale:webgpu-f32:n100 -->1291 ms<!-- /timing --> | 181× |
| 200 | <!-- timing:scale:wasm-f64:n200 -->6 ms<!-- /timing --> | <!-- timing:scale:webgpu-f32:n200 -->1323 ms<!-- /timing --> | 227× |
| 400 | <!-- timing:scale:wasm-f64:n400 -->6 ms<!-- /timing --> | <!-- timing:scale:webgpu-f32:n400 -->1653 ms<!-- /timing --> | 272× |
| 800 | <!-- timing:scale:wasm-f64:n800 -->7 ms<!-- /timing --> | <!-- timing:scale:webgpu-f32:n800 -->1601 ms<!-- /timing --> | 247× |
| 1600 | <!-- timing:scale:wasm-f64:n1600 -->7 ms<!-- /timing --> | <!-- timing:scale:webgpu-f32:n1600 -->1591 ms<!-- /timing --> | 228× |
| 3200 | <!-- timing:scale:wasm-f64:n3200 -->8 ms<!-- /timing --> | <!-- timing:scale:webgpu-f32:n3200 -->1784 ms<!-- /timing --> | 220× |
| 6400 | <!-- timing:scale:wasm-f64:n6400 -->10 ms<!-- /timing --> | <!-- timing:scale:webgpu-f32:n6400 -->1929 ms<!-- /timing --> | 179× |
| 12800 | <!-- timing:scale:wasm-f64:n12800 -->16 ms<!-- /timing --> | <!-- timing:scale:webgpu-f32:n12800 -->2000 ms<!-- /timing --> | 128× |
| 25600 | <!-- timing:scale:wasm-f64:n25600 -->24 ms<!-- /timing --> | <!-- timing:scale:webgpu-f32:n25600 -->2048 ms<!-- /timing --> | 79× |
| 51200 | <!-- timing:scale:wasm-f64:n51200 -->42 ms<!-- /timing --> | <!-- timing:scale:webgpu-f32:n51200 -->2206 ms<!-- /timing --> | 50× |
| 102400 | <!-- timing:scale:wasm-f64:n102400 -->85 ms<!-- /timing --> | <!-- timing:scale:webgpu-f32:n102400 -->2459 ms<!-- /timing --> | 27× |
| 204800 | <!-- timing:scale:wasm-f64:n204800 -->163 ms<!-- /timing --> | <!-- timing:scale:webgpu-f32:n204800 -->2982 ms<!-- /timing --> | 20× |
| 409600 | <!-- timing:scale:wasm-f64:n409600 -->317 ms<!-- /timing --> | <!-- timing:scale:webgpu-f32:n409600 -->3693 ms<!-- /timing --> | 12× |
| 819200 | <!-- timing:scale:wasm-f64:n819200 -->635 ms<!-- /timing --> | <!-- timing:scale:webgpu-f32:n819200 -->5978 ms<!-- /timing --> | 9.1× |
| 1638400 | <!-- timing:scale:wasm-f64:n1638400 -->1378 ms<!-- /timing --> | <!-- timing:scale:webgpu-f32:n1638400 -->9761 ms<!-- /timing --> | 7.4× |

Three findings:

1. **WASM stays flat up to N≈3200**, then grows roughly linearly (O(n)). The per-step cost asymptotes around \~0.8 µs/step (<!-- timing:scale:wasm-f64:n1638400 -->1378 ms (warm)<!-- /timing --> at N=1638400). The flat region reflects fixed JIT/dispatch overhead, not compute. WASM OOM previously occurred at N=3276800 due to a signed 32-bit integer overflow in the page-count calculation — fixed upstream in jax-js-nonconsuming (bb126c6+a6d37da).

2. **WebGPU cold timings include per-N JIT recompilation** (WebGPU `jit()` is not polymorphic in N). At small N the \~1200 ms JIT overhead dominates; at large N the GPU arithmetic dominates. Each associativeScan pass dispatches ⌈log₂N⌉+1 Kogge-Stone rounds, each operating on all N elements in parallel — so total GPU work is O(N log N), while WASM sequential scan is O(N). A 1024× increase from N=100 to N=102400 roughly doubles the runtime (<!-- timing:scale:webgpu-f32:n100 -->1291 ms (cold)<!-- /timing --> → <!-- timing:scale:webgpu-f32:n102400 -->2459 ms (cold)<!-- /timing -->).
...
**Performance**: on the `wasm` backend, one Nile MLE run (100 observations, m = 2) converges in <!-- timing:mle-bench:nile-order1:iterations -->190<!-- /timing --> iterations (\~<!-- timing:mle-bench:nile-order1:elapsed -->38 ms<!-- /timing -->) with Adam (b2=0.9), or <!-- timing:nat-mle-bench:nile-order1:iterations -->15<!-- /timing --> iterations (\~<!-- timing:nat-mle-bench:nile-order1:elapsed -->24 ms<!-- /timing -->) with the natural gradient optimizer.
...
| **WASM performance** | Adam: <!-- timing:mle-bench:nile-order1:elapsed -->38 ms<!-- /timing --> / <!-- timing:mle-bench:nile-order1:iterations -->190<!-- /timing --> iters; natural: <!-- timing:nat-mle-bench:nile-order1:elapsed -->24 ms<!-- /timing --> / <!-- timing:nat-mle-bench:nile-order1:iterations -->15<!-- /timing --> iters (Nile, n=100, m=2, incl. JIT) | N/A |
...
| Kaisaniemi, trig, fit s+w | 117 | 4 | 5 | <!-- timing:mle-bench:kaisaniemi:elapsed -->87 ms<!-- /timing --> | <!-- timing:nat-mle-bench:kaisaniemi:elapsed -->67 ms<!-- /timing --> | **failed** (NaN/Inf) | <!-- timing:mle-bench:kaisaniemi:lik -->341.3<!-- /timing --> | <!-- timing:nat-mle-bench:kaisaniemi:lik -->341.3<!-- /timing --> | — |
| Energy, trig+AR, fit s+w+φ | 120 | 5 | 7 | <!-- timing:energy-mle:elapsed-ms -->283 ms<!-- /timing --> | <!-- timing:nat-mle-bench:energy:elapsed -->139 ms<!-- /timing --> | — | <!-- timing:energy-mle:lik -->443.1<!-- /timing --> | <!-- timing:nat-mle-bench:energy:lik -->443.1<!-- /timing --> | — |
...
|---------|---|---|-------------------------------|---------------------------------------|---------|
| Nile, order=1 | 100 | 2 | <!-- timing:ckpt:nile:false-ms -->24 ms<!-- /timing --> | <!-- timing:ckpt:nile:true-ms -->20 ms<!-- /timing --> | <!-- timing:ckpt:nile:speedup -->-17%<!-- /timing --> |
| Energy, order=1+trig1+ar1 | 120 | 5 | <!-- timing:ckpt:energy:false-ms -->37 ms<!-- /timing --> | <!-- timing:ckpt:energy:true-ms -->35 ms<!-- /timing --> | <!-- timing:ckpt:energy:speedup -->-4%<!-- /timing --> |
