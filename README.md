...
|---------|-------|-----------|------|-------|------|-------|------|-------|------|-------|------|-------|------|
| **cpu** | **f64** | **scan** | **triu** | **163 ms** | **1.73e-16** | **370 ms** | **4.78e-13** | **462 ms** | **4.20e-11** | **534 ms** | **1.19e-11** | **381 ms** | **2.52e-13** |
|  |  | scan | off | 143 ms | 1.73e-16 | 298 ms | 1.40e-11 | 379 ms | 5.85e-10 | 435 ms | 1.06e-6 | 298 ms | 1.03e-12 |
|  |  | assoc | built-in | 79 ms | 4.87e-12 | 220 ms | 4.36e-9 | 1019 ms | 3.17e-8 | 1851 ms | 2.17e-7 | 231 ms | 1.29e-9 |
|  |  | ud | built-in | 267 ms | 1.30e-14 | 753 ms | 1.43e-12 | 1451 ms | 4.01e-5 | 1884 ms | 1.56e-10 | 767 ms | 1.02e-13 |
|  | **f32** | **scan** | **joseph** | **148 ms** | **9.93e-7** | **342 ms** | **2.25e-4** | **434 ms** | **2.93e-3** | **497 ms** | **6.18e-4** | **354 ms** | **1.74e-5** |
|  |  | scan | joseph+triu | 184 ms | 9.93e-7 | 394 ms | 1.09e-4 | 505 ms | 8.98e-3 | 564 ms | 1.41e-3 | 401 ms | 1.40e-4 |
|  |  | assoc | built-in | 71 ms | 4.74e-6 | 228 ms | 3.93e-3 | 1051 ms | 0.03 | 1882 ms | 0.20 | 230 ms | 1.51e-3 |
|  |  | ud | built-in | 253 ms | 1.06e-6 | 741 ms | 7.48e-4 | 1433 ms | 0.02 | 1841 ms | 1.02e-3 | 752 ms | 2.73e-5 |
| **wasm** | **f64** | **scan** | **triu** | **6 ms** | **1.73e-16** | **5 ms** | **4.78e-13** | **5 ms** | **4.20e-11** | **6 ms** | **1.19e-11** | **5 ms** | **2.52e-13** |
|  |  | scan | off | 4 ms | 1.73e-16 | 4 ms | 1.40e-11 | 4 ms | 5.85e-10 | 5 ms | 1.06e-6 | 5 ms | 1.03e-12 |
|  |  | assoc | built-in | 18 ms | 4.87e-12 | 23 ms | 4.36e-9 | 48 ms | 3.17e-8 | 65 ms | 2.17e-7 | 21 ms | 1.29e-9 |
|  |  | sqrt-assoc | built-in | 90 ms | 2.60e-15 | 131 ms | 5.73e-12 | 311 ms | 2.03e-6 | 437 ms | 1.70e-10 | 136 ms | 3.46e-13 |
|  |  | ud | built-in | 7 ms | 1.30e-14 | 7 ms | 1.43e-12 | 10 ms | 4.01e-5 | 12 ms | 1.56e-10 | 9 ms | 1.02e-13 |
|  | **f32** | **scan** | **joseph** | **4 ms** | **1.06e-6** | **4 ms** | **2.59e-4** | **6 ms** | **0.01** | **5 ms** | **2.08e-3** | **4 ms** | **1.32e-4** |
|  |  | scan | joseph+triu | 5 ms | 1.06e-6 | 6 ms | 7.11e-4 | 5 ms | 0.02 | 5 ms | 1.34e-3 | 5 ms | 2.48e-4 |
|  |  | assoc | built-in | 17 ms | 4.74e-6 | 22 ms | 4.53e-3 | 46 ms | 0.03 | 60 ms | 0.22 | 26 ms | 1.19e-3 |
|  |  | sqrt-assoc | built-in | 77 ms | 7.50e-7 | 128 ms | 3.07e-3 | 283 ms | 1.99 | 411 ms | 0.02 | 134 ms | 6.93e-4 |
|  |  | ud | built-in | 6 ms | 1.06e-6 | 7 ms | 7.96e-4 | 10 ms | 3.74e-3 | 11 ms | 1.30e-3 | 6 ms | 1.41e-5 |
| **webgpu** | **f32** | **assoc** | **built-in** | **148 ms** | **0.61** | **166 ms** | **0.97** | **237 ms** | **275** | **224 ms** | **1.71** | **174 ms** | **4.79** |
|  |  | scan | joseph | 215 ms | 100 | 212 ms | 1.37e+4 | 261 ms | 1.27e+4 | 326 ms | 2.49e+3 | 245 ms | 164 |
|  |  | scan | joseph+triu | 168 ms | 100 | 172 ms | 1.37e+4 | 206 ms | 1.27e+4 | 245 ms | 2.48e+3 | 201 ms | 164 |
|  |  | ud | built-in | 380 ms | 100 | 530 ms | 1.37e+4 | 886 ms | 1.27e+4 | 1221 ms | 2.49e+3 | 554 ms | 164 |
<!-- /generated -->
...
- **WASM stays flat up to N≈3200, then scales linearly** (~<!-- timing:scale:wasm-f64:n1638400 -->1411 ms (warm)<!-- /timing --> at N=1.6M). WebGPU scales sub-linearly at small N but approaches O(N) at large N (<!-- timing:scale:webgpu-f32:n100 -->366 ms (cold)<!-- /timing --> → <!-- timing:scale:webgpu-f32:n102400 -->1827 ms (cold)<!-- /timing --> for a 1024× increase). No crossover was observed up to N=1.6M; see scaling table.
...
|-------|-----|-----|--------------------------|------------------------------|
| Nile, order=0 | 100 | 1 | <!-- timing:bb:nile-o0:wasm-f64 -->8 ms<!-- /timing --> | <!-- timing:bb:nile-o0:webgpu-f32 -->125 ms<!-- /timing --> |
| Nile, order=1 | 100 | 2 | <!-- timing:bb:nile-o1:wasm-f64 -->6 ms<!-- /timing --> | <!-- timing:bb:nile-o1:webgpu-f32 -->122 ms<!-- /timing --> |
| Kaisaniemi, trig | 117 | 4 | <!-- timing:bb:kaisaniemi:wasm-f64 -->7 ms<!-- /timing --> | <!-- timing:bb:kaisaniemi:webgpu-f32 -->182 ms<!-- /timing --> |
| Energy, trig+AR | 120 | 5 | <!-- timing:bb:trigar:wasm-f64 -->6 ms<!-- /timing --> | <!-- timing:bb:trigar:webgpu-f32 -->184 ms<!-- /timing --> |
...
|---|----------------------|-------------------------|-------|
| 100 | <!-- timing:scale:wasm-f64:n100 -->10 ms<!-- /timing --> | <!-- timing:scale:webgpu-f32:n100 -->366 ms<!-- /timing --> | 17.9× |
| 200 | <!-- timing:scale:wasm-f64:n200 -->7 ms<!-- /timing --> | <!-- timing:scale:webgpu-f32:n200 -->434 ms<!-- /timing --> | 18.4× |
| 400 | <!-- timing:scale:wasm-f64:n400 -->8 ms<!-- /timing --> | <!-- timing:scale:webgpu-f32:n400 -->546 ms<!-- /timing --> | 18.3× |
| 800 | <!-- timing:scale:wasm-f64:n800 -->7 ms<!-- /timing --> | <!-- timing:scale:webgpu-f32:n800 -->736 ms<!-- /timing --> | 19.6× |
| 1600 | <!-- timing:scale:wasm-f64:n1600 -->8 ms<!-- /timing --> | <!-- timing:scale:webgpu-f32:n1600 -->1090 ms<!-- /timing --> | 19.7× |
| 3200 | <!-- timing:scale:wasm-f64:n3200 -->9 ms<!-- /timing --> | <!-- timing:scale:webgpu-f32:n3200 -->1692 ms<!-- /timing --> | 21.2× |
| 6400 | <!-- timing:scale:wasm-f64:n6400 -->11 ms<!-- /timing --> | <!-- timing:scale:webgpu-f32:n6400 -->2979 ms<!-- /timing --> | 21.2× |
| 12800 | <!-- timing:scale:wasm-f64:n12800 -->16 ms<!-- /timing --> | <!-- timing:scale:webgpu-f32:n12800 -->5300 ms<!-- /timing --> | 20.1× |
| 25600 | <!-- timing:scale:wasm-f64:n25600 -->26 ms<!-- /timing --> | <!-- timing:scale:webgpu-f32:n25600 -->9888 ms<!-- /timing --> | 14.8× |
| 51200 | <!-- timing:scale:wasm-f64:n51200 -->43 ms<!-- /timing --> | <!-- timing:scale:webgpu-f32:n51200 -->19363 ms<!-- /timing --> | 15.4× |
| 102400 | <!-- timing:scale:wasm-f64:n102400 -->100 ms<!-- /timing --> | <!-- timing:scale:webgpu-f32:n102400 -->1827 ms<!-- /timing --> | 13.8× |
| 204800 | <!-- timing:scale:wasm-f64:n204800 -->181 ms<!-- /timing --> | <!-- timing:scale:webgpu-f32:n204800 -->2943 ms<!-- /timing --> | 12.3× |
| 409600 | <!-- timing:scale:wasm-f64:n409600 -->338 ms<!-- /timing --> | <!-- timing:scale:webgpu-f32:n409600 -->4853 ms<!-- /timing --> | 10.2× |
| 819200 | <!-- timing:scale:wasm-f64:n819200 -->677 ms<!-- /timing --> | <!-- timing:scale:webgpu-f32:n819200 -->9376 ms<!-- /timing --> | 10.0× |
| 1638400 | <!-- timing:scale:wasm-f64:n1638400 -->1411 ms<!-- /timing --> | <!-- timing:scale:webgpu-f32:n1638400 -->17978 ms<!-- /timing --> | 9.5× |

Three findings:

1. **WASM stays flat up to N≈3200**, then grows roughly linearly (O(n)). The per-step cost asymptotes around ~1.2 µs/step (<!-- timing:scale:wasm-f64:n1638400 -->1411 ms (warm)<!-- /timing --> at N=1638400). The flat region reflects fixed JIT/dispatch overhead, not compute. WASM OOM previously occurred at N=3276800 due to a signed 32-bit integer overflow in the page-count calculation — fixed upstream in jax-js-nonconsuming (bb126c6+a6d37da).

2. **WebGPU cold timings include per-N JIT recompilation** (WebGPU `jit()` is not polymorphic in N). At small N the ~500 ms JIT overhead dominates; at large N the GPU arithmetic dominates. Each associativeScan pass dispatches ⌈log₂N⌉+1 Kogge-Stone rounds, each operating on all N elements in parallel — so total GPU work is O(N log N), while WASM sequential scan is O(N). A 1024× increase from N=100 to N=102400 roughly triples the runtime (<!-- timing:scale:webgpu-f32:n100 -->366 ms (cold)<!-- /timing --> → <!-- timing:scale:webgpu-f32:n102400 -->1827 ms (cold)<!-- /timing -->).
...
**Performance**: on the `wasm` backend, one Nile MLE run (100 observations, m = 2) converges in <!-- timing:mle-bench:nile-order1:iterations -->190<!-- /timing --> iterations (~<!-- timing:mle-bench:nile-order1:elapsed -->45 ms<!-- /timing -->) with Adam (b2=0.9), or <!-- timing:nat-mle-bench:nile-order1:iterations -->15<!-- /timing --> iterations (~<!-- timing:nat-mle-bench:nile-order1:elapsed -->25 ms<!-- /timing -->) with the natural gradient optimizer.
...
|-------|---|---|--------|--------------------|-----------------------|---------------------|-------------------|----------------------|---------------------|
| Nile, order=1, fit s+w | 100 | 2 | 3 | <!-- timing:mle-bench:nile-order1:elapsed -->45 ms<!-- /timing --> | <!-- timing:nat-mle-bench:nile-order1:elapsed -->25 ms<!-- /timing --> | <!-- computed:static("octave-nile-order1-elapsed-ms") + " ms" -->2814 ms<!-- /computed --> | <!-- timing:mle-bench:nile-order1:lik -->1104.9<!-- /timing --> | <!-- timing:nat-mle-bench:nile-order1:lik -->1104.9<!-- /timing --> | <!-- computed:static("octave-nile-order1-lik") -->1104.6<!-- /computed --> |
...
| Energy, trig+AR, fit s+w+φ | 120 | 5 | 7 | <!-- timing:energy-mle:elapsed-ms -->301 ms<!-- /timing --> | <!-- timing:nat-mle-bench:energy:elapsed -->150 ms<!-- /timing --> | — | <!-- timing:energy-mle:lik -->443.1<!-- /timing --> | <!-- timing:nat-mle-bench:energy:lik -->443.1<!-- /timing --> | — |
...
|---------|---|---|-------------------------------|---------------------------------------|---------|
| Nile, order=1 | 100 | 2 | <!-- timing:ckpt:nile:false-ms -->25 ms<!-- /timing --> | <!-- timing:ckpt:nile:true-ms -->21 ms<!-- /timing --> | <!-- timing:ckpt:nile:speedup -->-16%<!-- /timing --> |
